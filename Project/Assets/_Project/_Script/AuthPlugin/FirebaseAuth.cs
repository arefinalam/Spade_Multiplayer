...
namespace FirebaseWebGL.Scripts.FirebaseBridge
{
    public static class FirebaseAuth
    {
        ...
        /// <summary>
        /// Sends a email with a link to reset password
        /// </summary>
        /// <param name="objectName"> Name of the gameobject to call the callback/fallback of </param>
        /// <param name="email"></param>
        /// <param name="callback"> Name of the method to call when the email sent is successfull </param>
        /// <param name="fallback"> Name of the method to call when the email sent is unsuccessfull </param>
        [DllImport("__Internal")]        
        public static extern void SendPassResetEmail(string objectName, string email, string callback, string fallback);

        /// <summary>
        /// Does exactly what it says.
        /// </summary>
        /// <param name="objectName"> Name of the gameobject to call the callback/fallback of </param>
        /// <param name="callback"> Name of the method to call when signout is successfull </param>
        /// <param name="fallback"> Name of the method to call when signout is unsuccessfull </param>
        [DllImport("__Internal")]
